...
boolean animdead;
    Modifikator mod;
    public Kaban(int xx, int yy, long id, LabelStyle lsuron,Game game) {
...
// атака
    ...
    public void dopDraw(Batch sb, ShapeRenderer sr) {
       ...
       if(sr.isDrawing())if(state!=Util.DIED)sr.rect(x  ,y + 33,life.life / ld, 1,colorlife,colorlife,colorlife,colorlife);
    }
