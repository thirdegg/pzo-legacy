...
public class TmxMapLoade extends BaseTmxMapLoader<com.badlogic.gdx.maps.tiled.TmxMapLoader.Parameters> {
     ...
     *
     * @param resolver */
    public TmxMapLoade (FileHandleResolver resolver) {
        super(resolver);
    }
    ...
    public TiledMap load(String fileName, TextureAtlas atlas) {
        return load(fileName, new TmxMapLoade.Parameters(), atlas);
    }
     ...
     * @return the TiledMap */
    public TiledMap load(String fileName, TmxMapLoade.Parameters parameters, TextureAtlas atlas) {
        try {
            this.convertObjectToTileSpace = parameters.convertObjectToTileSpace;
            this.flipY = parameters.flipY;
            FileHandle tmxFile = resolve(fileName);
            root = xml.parse(tmxFile);
            TextureAtlasImageResolver imageResolver = new TextureAtlasImageResolver(atlas);
            TiledMap map = loadTilemap(root, tmxFile, imageResolver);
            //	map.setOwnedResources((Array<? extends Disposable>) atlas.getRegions());
            return map;
        } catch (IOException e) {
    ...
    @Override
    public void loadAsync (AssetManager manager, String fileName, FileHandle tmxFile, com.badlogic.gdx.maps.tiled.TmxMapLoader.Parameters parameter) {
        map = null;
    ...
    @Override
    public TiledMap loadSync (AssetManager manager, String fileName, FileHandle file, com.badlogic.gdx.maps.tiled.TmxMapLoader.Parameters parameter) {
        return map;
    }
    ...
    @Override
    public Array<AssetDescriptor> getDependencies (String fileName, FileHandle tmxFile, com.badlogic.gdx.maps.tiled.TmxMapLoader.Parameters parameter) {
    ...
    protected void loadTileSet(TiledMap map, Element element, FileHandle tmxFile, ImageResolver imageResolver) {
        if (element.getName().equals("tileset")) {
            ...
            if (image != null) {
               // TextureRegion texture = new TextureRegion(new Texture("back.png"));
                TextureRegion texture = imageResolver.getImage("back");
