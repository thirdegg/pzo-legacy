...
public class Impuls2 extends MapObject {
    ...
    float cellx,celly;
    boolean run2=true;
    public Impuls2(int xx, int yy, long id, HashMap<Long, MapObject> mapobjects){
        super("impuls2.png", xx - 49, yy - 30, 50,null,false);
        this.id = id;
        centx = xx;
        centy = yy;
        ...
        if(run){
            ...
            if (timezarad > 7&&run2) {
                if(atakobject!=null){
                    ...
                    atakobject.signal(4,new AnomalyJump(atakobject,naprav,80,15,true));
