...
/**
 * Created by 777 on 04.03.2017.
 */
public class WorldMap14 extends  WMap{
    public WorldMap14() {
        super();
        //map 1600x1600 world 1575x1565
        idmap=14;
        String mapname="map14.tmx";
        ...
        createobjects.add(new ObjectParametr(Util.BOSKABAN,Util.PPBOS,1,1167,994,180000,null));
